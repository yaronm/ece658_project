...
public class PotluckFacade implements Serializable{
    ...
    */
    public PotluckFacade(String owner, String owner_email) throws AddressException{
     ...
     */
    public void from_template(PotluckFacade temp) {
    ...
    public void add_restrictions(Map<String, String> new_restrictions) {
      ...
      //should probably send notification to guests that this has been changed
    }
